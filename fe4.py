...
mlflow.set_experiment("car_detection_experiment")
    ...
    if uploaded_file is not None:
        ...
        with mlflow.start_run():
            ...
            mlflow.log_params({
                ...
                "learning_rate": learning_rate if selected_model == "ResNet" else None,
                "num_epochs": num_epochs if selected_model == "ResNet" else None,
                "confidence_threshold": confidence_threshold if selected_model == "YOLO" else None,
                "input_size": input_size if selected_model == "YOLO" else None
            })
            ...
            # Log processed image as an artifact
            mlflow.log_image(cv_plot, "processed_image")

            # Display the processed image with bounding boxes
            st.header("Processed Image with Bounding Boxes")
            st.image(cv_plot, caption="Processed Image", use_column_width=True)
